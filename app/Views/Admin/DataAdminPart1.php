                ...
                <form id="ingresarRegion" class="form-horizontal form-material mx-2" method="POST" action="<?= base_url(route_to('registrarregion')) ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nombre" name="reg_nombre" class="form-control form-control-line" id="reg_nombre">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Numero de la region:</label>
                            <div class="col-md-12">
                                <input type="number" placeholder="Numero" name="reg_numero" class="form-control form-control-line" id="reg_numero">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Estado:</label>
                ...
                <form id="ingresarSubRegion" class="form-horizontal form-material mx-2" method="POST" action="<?= base_url(route_to('registrarsubregion')) ?>">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Nombre" name="sre_nombre" class="form-control form-control-line" id="sre_nombre">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Telefono 1:</label>
                            <div class="col-md-12">
                                <input type="number" placeholder="Numero" name="sre_telefono1" class="form-control form-control-line" id="sre_telefono1">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Telefono 2:</label>
                            <div class="col-md-12">
                                <input type="number" placeholder="Numero" name="sre_telefono2" class="form-control form-control-line" id="sre_telefono2">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Telefono 3:</label>
                            <div class="col-md-12">
                                <input type="number" placeholder="Numero" name="sre_telefono3" class="form-control form-control-line" id="sre_telefono3">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Correo Electronico:</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="Correo Electronico" name="sre_correo" class="form-control form-control-line" id="sre_correo">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" placeholder="Nombre" name="sre_nombre" value="<?= $subregion['sre_nombre'] ?>" class="form-control form-control-line" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Telefono1</label>
                                <div class="col-md-12">
                                    <input type="number" placeholder="Numero" name="sre_telefono1" value="<?= $subregion['sre_telefono1'] ?>" class="form-control form-control-line" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-12">Correo Electronico:</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Correo Electronico" name="sre_correo" value="<?= $subregion['sre_correo'] ?>" class="form-control form-control-line" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Dirección:</label>
