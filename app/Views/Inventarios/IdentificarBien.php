                    ...
                    <div class="page-breadcrumb">
                        <div class="row">
                            <div class="col-5 align-self-center">
                                <h4 class="page-title">Consulta de información unidad de compras</h4>
                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <?php foreach ($usuarios as $persona) : ?>
                                                <?php if ($persona['per_id'] == $per_encargado) : ?>
                                                    <input type="text" class="form-control form-control-user" value="<?= $persona['per_nombre'] . ' ' . $persona["per_apellido"] ?>"  />
